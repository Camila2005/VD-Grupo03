 ...
 /* etiqueta destacada para EE.UU. con flecha apuntando al círculo */
  ...
  ScrollTrigger.create({
    ...
    onEnter: () => {
      ...
      gsap.to("#mapaEyebrow", { opacity:1, y:0, duration:1, ease:"power2.out" });
      gsap.to("#mapaLeyenda", { opacity:1, duration:1, delay:0.5 });
    ...
    onLeaveBack: () => {
      ...
      gsap.to("#mapaEyebrow", { opacity:0, y:12, duration:0.4 });
      gsap.to("#mapaLeyenda", { opacity:0, duration:0.4 });
    }
  });
